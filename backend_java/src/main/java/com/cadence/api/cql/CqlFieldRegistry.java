...
public final class CqlFieldRegistry {
	...
	public static final Map<String, FieldSpec> FIELD_SPECS = Map.ofEntries(
			...
			Map.entry("temperature", new FieldSpec(true, "air temp", "°C")),
			Map.entry("humidity", new FieldSpec(true, "humidity", "%")),
			Map.entry("avg_heat_strain", new FieldSpec(true, "avg heat strain", "")),
			Map.entry("max_heat_strain", new FieldSpec(true, "max heat strain", "")),
			Map.entry("avg_core_temp", new FieldSpec(true, "avg core temp", "°C")),
			Map.entry("max_core_temp", new FieldSpec(true, "max core temp", "°C")),
			Map.entry("avg_skin_temp", new FieldSpec(true, "avg skin temp", "°C")),
			Map.entry("max_skin_temp", new FieldSpec(true, "max skin temp", "°C")),
			Map.entry("start_weight_kg", new FieldSpec(true, "start weight", "kg")),
			Map.entry("end_weight_kg", new FieldSpec(true, "end weight", "kg")),
			Map.entry("fluids_ml", new FieldSpec(true, "fluids consumed", "ml")),
	...
	public static final Map<String, String> FIELD_ALIASES = Map.ofEntries(
			...
			Map.entry("pace", "pace"),
			Map.entry("temperature", "temperature"), Map.entry("temp", "temperature"), Map.entry("airtemp", "temperature"),
			Map.entry("humidity", "humidity"), Map.entry("hum", "humidity"),
			Map.entry("avg_heat_strain", "avg_heat_strain"), Map.entry("max_heat_strain", "max_heat_strain"),
			Map.entry("avg_core_temp", "avg_core_temp"), Map.entry("max_core_temp", "max_core_temp"),
			Map.entry("avg_skin_temp", "avg_skin_temp"), Map.entry("max_skin_temp", "max_skin_temp"),
			Map.entry("start_weight_kg", "start_weight_kg"), Map.entry("end_weight_kg", "end_weight_kg"),
			Map.entry("fluids_ml", "fluids_ml"),
