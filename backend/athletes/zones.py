...
def reference_for(athlete, zone_type):
    ...
    return _mmss_to_seconds(raw) if zone_type == "pace" else raw


def get_or_create_zone_set(athlete, zone_type):
...
def zone_types_affected_by(changed_fields):
