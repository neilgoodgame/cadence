...
from .views import (
    ...
    ActivityTagView,
    ActivityUntagView,
    ActivityWorkoutMatchCandidatesView,
    CurvesView,
    InferWorkoutView,
    LapListView,
    RecomputeActivityStatsView,
    RecomputeActivityTssView,
    RegenerateActivityLapsView,
    StreamsView,
    TagDetailView,
    TagListView,
)
...
urlpatterns = [
    ...
    path(
        "v1/activities/<str:id>/regenerate-laps",
        RegenerateActivityLapsView.as_view(),
        name="activity-regenerate-laps",
    ),
    path("v1/activities/<str:id>/infer-workout", InferWorkoutView.as_view(), name="activity-infer-workout"),
    path(
        "v1/activities/<str:id>/workout-match-candidates",
        ActivityWorkoutMatchCandidatesView.as_view(),
        name="activity-workout-match-candidates",
    ),
