...
from .views import (
    ...
    ActivityListView,
    ActivityTagView,
    ActivityThresholdSuggestionView,
    ActivityUntagView,
    CurvesView,
    InferWorkoutView,
    LapListView,
    RecomputeActivityStatsView,
    RecomputeActivityThresholdsView,
...
urlpatterns = [
    ...
    path(
        "v1/activities/<str:id>/threshold-suggestion",
        ActivityThresholdSuggestionView.as_view(),
        name="activity-threshold-suggestion",
    ),
    path(
        "v1/activities/<str:id>/recompute-thresholds",
        RecomputeActivityThresholdsView.as_view(),
        name="activity-recompute-thresholds",
    ),
