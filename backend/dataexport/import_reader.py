        ...
        for entry in ijson.items(gz, "activities.item", use_float=True):
            ...
            try:
                ...
                activity = Activity.objects.create(
                    ...
                    avg_heat_strain=ar.get("avg_heat_strain"),
                    max_heat_strain=ar.get("max_heat_strain"),
                    avg_core_temp=ar.get("avg_core_temp"),
                    max_core_temp=ar.get("max_core_temp"),
                    avg_skin_temp=ar.get("avg_skin_temp"),
                    max_skin_temp=ar.get("max_skin_temp"),
